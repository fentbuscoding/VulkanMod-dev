...
public class Renderer {
    ...
    // private FfxFsr1Context fsrContext;
    ...
    // private void setupFSR() {
    //     FfxFsr1ContextDescription fsrContextDesc = new FfxFsr1ContextDescription();
    //     fsrContextDesc.device = device;
    //     fsrContextDesc.commandList = currentCmdBuffer;
    //     fsrContextDesc.input.width = swapChain.getWidth();
    //     fsrContextDesc.input.height = swapChain.getHeight();
    //     fsrContextDesc.input.format = VK_FORMAT_R8G8B8A8_SRGB;
    //     fsrContextDesc.output.width = swapChain.getWidth();
    //     fsrContextDesc.output.height = swapChain.getHeight();
    //     fsrContextDesc.output.format = VK_FORMAT_R8G8B8A8_SRGB;

    //     fsrContext = new FfxFsr1Context();
    //     ffxFsr1ContextCreate(fsrContext, fsrContextDesc);
    // }

    // public void applyFSR() {
    //     if (fsrContext != null) {
    //         FfxFsr1ContextDescription fsrContextDesc = new FfxFsr1ContextDescription();
    //         fsrContextDesc.device = device;
    //         fsrContextDesc.commandList = currentCmdBuffer;
