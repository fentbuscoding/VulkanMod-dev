...
//            System.out.println("new layout is equal to current layout");
    ...
    public static void batchTransitionImageLayouts(MemoryStack stack, VkCommandBuffer commandBuffer, VulkanImage[] images, int newLayout) {
        ...
        for (int i = 0; i < images.length; i++) {
            ...
            int srcAccessMask, sourceStage, dstAccessMask = 0, destinationStage;
